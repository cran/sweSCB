...
Version 0.3.5 was released on 22th of July, 2014.  

- Small dependency corrections with httr
...
## Installation
The current package on CRAN is v.0.3.4. This version can be downloaded as follows:
```r
